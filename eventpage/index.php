											...
											<ul>
												<li class="menu-item-has-children active">
													...
													<!-- <ul class="sub-menu">
														...
														<li class="menu-item-has-children">
															<a href='index-2.php' class="active">home v.2</a>
															<ul class="sub-menu">
																<li>
												...
												<li class="menu-item-has-children">
													...
													<ul class="sub-menu">
														<li class="menu-item-has-children">
															...
															<ul class="sub-menu">
																<li><a href="event-1-without-sidebar.php">list without sidebar</a></li>
															</ul>
														</li>
														<li class="menu-item-has-children">
															<a href='event-2.php'>event Grid</a>
															<ul class="sub-menu">
																<li><a href="event-2-without-sidebar.php">grid without sidebar</a></li>
															</ul>
														</li>
														<li><a href='event-details.php'>event details</a></li>
														<li><a href='booking.php'>event booking</a></li>
													</ul>
												</li>
												<li class="menu-item-has-children">
													<a href="#!">blogs</a>
														...
														<div class="overlay-black clearfix">
															...
															<div class="leftside-content">
																...
																<div class="copyright-text">
																	<p class="m-0">©2019 <a href="#!" class="yellow-color">xyz.com</a> all right reserved, made with <i class="fas fa-heart"></i> by jThemes Studio </p>
																</div>
															</div>
								...
								<div id="alt-login-modal" class="reglog-modal-wrapper mfp-hide clearfix" style="background-image: url(assets/images/login-modal-bg.jpg);">
									<div class="overlay-black clearfix">
										...
										<div class="leftside-content">
											...
											<div class="copyright-text">
												<p class="m-0">©2018 <a href="#!" class="yellow-color">xyz.com</a> all right reserved, made with <i class="fas fa-heart"></i> by jThemes Studio </p>
											</div>
										</div>
										<!-- leftside-content - end -->
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-12 col-sm-12">
						<div class="section-title text-left mb-30">
							...
							<small class="sub-title">we are xyz</small>
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="section-title">
								<small class="sub-title">xyz gallery</small>
										...
										<div class="col-lg-6 col-md-12 col-sm-12">
											<div class="speaker-content">
												...
												<div class="section-title text-left mb-50">
													<span class="line-style"></span>
													<small class="sub-title">xyz staffs</small>
							...
							<div class="slider-nav">
								<div class="item">
									<div class="item-content">
										...
										<span class="sub-title">xyz Speaker</span>
									</div>
								</div>
						...
						<div id="testimonial5-carousel" class="testimonial5-carousel owl-carousel owl-theme">
							...
							<div class="item text-center">
								...
								<p class="clients-comment">
									“Bring people together, or turn your passion into a business. xyz gives you everything you need to host your best event yet. lorem ipsum diamet. Bring people together, or turn your passion into a business. xyz gives you everything you need to host your best event yet.”
								</p>
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-12 col-sm-12">
							<div class="section-title text-left">
								<span class="line-style"></span>
								<small class="sub-title">xyz events</small>
							...
							<div class="card">
								<div class="card-header" id="headingone">
									<button class="btn collapsed" data-toggle="collapse" data-target="#collapseone" aria-expanded="true" aria-controls="collapseone">
										<span>01.</span> How to join xyz Event Management?
									</button>
								</div>
								...
								<div id="collapseone" class="collapse" aria-labelledby="headingone" data-parent="#faq-accordion">
									<div class="card-body">
										<h3>answer</h3>
										Bring people together, or turn your passion into a business. xyz gives you everything you need to host your best event yet. lorem ipsum diamet.
									</div>
								</div>
							</div>
						...
						<div class="latest-blog-wrapper">
							...
							<div class="latest-blog clearfix">
								...
								<div class="blog-content">
									...
									<p class="m-0">
										xyz gives you everything you need to host your best event yet. lorem ipsum diamet.
									</p>
								</div>
							</div>
							<!-- latest-blog - end -->
			...
			<div class="address-wrapper">
				...
				<div class="address-info-topbar mb-30 clearfix">
					<div class="address-info-left">
						<h3 class="title-text">xyz event management</h3>
						<p class="m-0">
			...
			<div class="footer-bottom">
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-7 col-md-12 col-sm-12">
							<div class="copyright-text">
								<p class="m-0">©2018 <a href="#!" class="site-link">xyz.com</a> all right reserved, made with <i class="fas fa-heart"></i> by <a href="#!" class="author-link"><strong>jThemes Studio</strong></a></p>
							</div>
						</div>
						<!-- copyright-text - end -->
